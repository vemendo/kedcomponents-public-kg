...
// Element Variables:
var COURSE_BUILDER_URL = scriptVariables.COURSE_BUILDER_URL, NOCSS = scriptVariables.NOCSS;
// Vendor scripts
...
executeClientScript(function (courseBuilderUrl) {
    ReactDOM.render(React.createElement(KED.components.KEDAppCourseViewer, {
        courseBuilderUrl: courseBuilderUrl
