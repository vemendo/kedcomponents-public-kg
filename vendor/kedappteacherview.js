...
var CourseModuleView = (function (_a) {
    ...
    var getNotSubmittedUsers = function (taskAssignments) {
        ...
        studyGroups.forEach(function (group) {
            var users = _apis_mock_mock_classroom_data__WEBPACK_IMPORTED_MODULE_5__["mockTuitionStudents"][group] && _apis_mock_mock_classroom_data__WEBPACK_IMPORTED_MODULE_5__["mockTuitionStudents"][group].filter(function (cs) { return !taskAssignments.find(function (f) { return f.user === cs.studentEmailAddress; }); })
