...
/* harmony import */ var _components_kg_termplanner__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/kg-termplanner */ "./src/components/kg-termplanner/index.tsx");
/* harmony import */ var _components_ks_termplanner2_termplanner__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/ks-termplanner2/termplanner */ "./src/components/ks-termplanner2/termplanner.tsx");
...
/* harmony import */ var _components_weekplanner__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/weekplanner */ "./src/components/weekplanner/index.ts");
/* harmony import */ var _components_learning_tasks__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/learning-tasks */ "./src/components/learning-tasks/index.tsx");
/* harmony import */ var _components_my_courses_my_courses__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/my-courses/my-courses */ "./src/components/my-courses/my-courses.tsx");
/* harmony import */ var _components_list_courses_list_courses__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/list-courses/list-courses */ "./src/components/list-courses/list-courses.tsx");
...
var components = {
    ...
    KSTermPlanner: {
        component: _components_ks_termplanner2_termplanner__WEBPACK_IMPORTED_MODULE_5__["KSTermPlanner"],
        props: function () { return ({
            initialDate: new Date(),
            userEmail: _globals_KED_env__WEBPACK_IMPORTED_MODULE_6__["default"].currentUser.mail,
            locale: 'sv'
        }); }
    },
    KGTermPlanner: {
        component: _components_kg_termplanner__WEBPACK_IMPORTED_MODULE_4__["KGTermPlanner"],
        props: function () { return ({}); }
    },
    WeekPlanner: {
        component: _components_weekplanner__WEBPACK_IMPORTED_MODULE_7__["WeekPlanner"],
        props: function () { return ({
    ...
    Calendar: {
        ...
        props: function () { return ({
            locale: "sv",
            firstDay: moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf('week').weekday(0),
            numDays: 5,
            initialStartHour: 7,
            initialEndHour: 18,
            initialZoom: 0.75
    ...
    LearningTasks: {
        component: _components_learning_tasks__WEBPACK_IMPORTED_MODULE_8__["LearningTasks"],
        props: function () { return ({
    ...
    MyCourses: {
        component: _components_my_courses_my_courses__WEBPACK_IMPORTED_MODULE_9__["MyCourses"],
        props: function () { return ({
            viewCourseUrl: 'https://kg-test.sitevision.se/courseviewer'
        }); }
    },
    ListCourses: {
        component: _components_list_courses_list_courses__WEBPACK_IMPORTED_MODULE_10__["ListCourses"],
        props: function () { return ({
            viewCourseUrl: 'https://kg-test.sitevision.se/courseviewer'
        }); }
    }
...
var TestPage = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](TestPage, _super);
    function TestPage(props) {
        var _this = _super.call(this, props) || this;
        _this.state = {
            selectedComponent: localStorage.getItem("selectedComponent") || Object.keys(_components__WEBPACK_IMPORTED_MODULE_9__["components"])[0],
    ...
    TestPage.prototype.componentDidUpdate = function () {
    ...
    TestPage.prototype.renderTestComponent = function () {
        _globals_KED_env__WEBPACK_IMPORTED_MODULE_3__["default"].learningModuleTasks = _data_learningModules__WEBPACK_IMPORTED_MODULE_6__["learningModules"][this.state.selectedLearningModule];
        jquery__WEBPACK_IMPORTED_MODULE_10___default()(this.componentArea).html("");
        if (_globals_KED_env__WEBPACK_IMPORTED_MODULE_3__["default"].currentUser) {
            react_dom__WEBPACK_IMPORTED_MODULE_5__["render"](react__WEBPACK_IMPORTED_MODULE_4__["createElement"](_components__WEBPACK_IMPORTED_MODULE_9__["components"][this.state.selectedComponent].component, _components__WEBPACK_IMPORTED_MODULE_9__["components"][this.state.selectedComponent].props(), null), this.componentArea);
        }
    };
    TestPage.prototype.render = function () {
        var _this = this;
        return _globals_KED_env__WEBPACK_IMPORTED_MODULE_3__["default"].currentUser ? react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "test-page" },
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "header" },
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "test-selects" },
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("form", null,
                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("h4", null, "Testsida f\u00F6r komponenter till nya startsidan"),
                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("table", null,
                            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("tbody", null,
                                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("tr", null,
                                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("td", null,
                                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("label", { htmlFor: "testComponent" }, "Komponent")),
                                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("td", null,
                                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("select", { id: "testComponent", value: this.state.selectedComponent, onChange: function (ev) {
                                                _this.setState({ selectedComponent: ev.target.value });
                                                localStorage.setItem("selectedComponent", ev.target.value);
                                                window.location.reload();
                                            } }, Object.keys(_components__WEBPACK_IMPORTED_MODULE_9__["components"]).map(function (c) { return react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("option", { key: c, value: c }, c); })))),
                                this.state.selectedComponent === 'LearningGoalsAndTasks' && react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("tr", null,
                                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("td", null,
                                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("label", { htmlFor: "testLearningModule" }, "Kursmodul")),
                                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("td", null,
                                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("select", { id: "testLearningModule", value: this.state.selectedLearningModule, onChange: function (ev) {
                                            ...
                                            return react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("option", { key: i, value: i }, lm.subject.course.name + "/" +
                                                lm.subject.name + "/" +
                                                lm.moduleName);
                                        })))),
                                this.state.selectedComponent === 'LearningTasks' && react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("tr", null,
                                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("td", null,
                                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("label", { htmlFor: "testLearningModuleUrl" }, "Kursmodul")),
                                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("td", null,
                                        react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("select", { id: "testLearningModuleUrl", value: this.state.selectedLearningModuleUrl, onChange: function (ev) {
                                            ...
                                            return react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("option", { key: i, value: url }, url);
                                        }))))))))),
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("hr", null),
            react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "componentRow" },
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "componentArea", ref: function (div) { return _this.componentArea = div; } }),
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"]("div", { className: "week-planner" }, this.state.selectedComponent === 'LearningTasks' &&
                    react__WEBPACK_IMPORTED_MODULE_4__["createElement"](_components_weekplanner__WEBPACK_IMPORTED_MODULE_8__["WeekPlanner"], { viewCourseUrl: "http://www.svt.se/nyheter" })))) : react__WEBPACK_IMPORTED_MODULE_4__["createElement"](_utils_choose_user__WEBPACK_IMPORTED_MODULE_11__["ChooseUser"], null);
    };
    return TestPage;
